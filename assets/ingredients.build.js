const selectors = {
  section: ".js-ingredients",
  item: ".js-ingredients-item",
  flashlight: ".js-ingredients-item-flashlight-effect"
};
const Ingredients = () => {
...
const action = () => {
  window.themeCore.ingredients = window.themeCore.ingredients || Ingredients();
  window.themeCore.utils.register(window.themeCore.ingredients, "ingredients");
};
